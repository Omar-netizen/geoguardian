...
import { Mail, Lock, LogIn, Shield, Satellite, AlertCircle, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-blue-50 relative overflow-hidden p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-teal-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>

      {/* Floating icons */}
      <Satellite className="absolute top-10 right-20 text-teal-300 opacity-20 w-16 h-16 animate-pulse" style={{ animationDuration: '4s' }} />
      <Shield className="absolute bottom-20 left-20 text-emerald-300 opacity-20 w-12 h-12 animate-pulse" style={{ animationDuration: '3s', animationDelay: '1s' }} />
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 mt-2">Login to GeoGuardian</p>
          </div>
        ...
        <p className="text-center mt-6 text-slate-500 text-sm">
          Monitoring Earth's changes, one satellite image at a time
        </p>
      </div>
    </div>
  );
